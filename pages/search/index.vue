<template>
  <v-container>
    <v-row class="mt-12 px-7">
      <p class="title">Search</p>
      <v-btn class="ml-10" color="primary">Admain search</v-btn>
    </v-row>
    <v-row class="px-7 justify-center">
      <v-text-field
        v-model="searchJobId"
        clearable
        solo
        label="P00001/User/Species/Tissue?"
        type="search"
        outlined
      ></v-text-field>
      <v-btn class="ml-2" color="primary" height="56">Go</v-btn>
    </v-row>
    <v-row class="justify-center">
      <v-card class="my-12" color="#ECEFF1" outlined rounded="lg">
        ...
        <v-row class="my-4" justify="space-around">
          ...
          <v-card outlined rounded="lg"
            ><v-card-subtitle class="justify-center"
              >Owner: XXXX</v-card-subtitle
            ></v-card
          >
          <v-card outlined rounded="lg"
            ><v-card-subtitle class="justify-center"
              >Created: 10/29/2020</v-card-subtitle
            ></v-card
          >
          <v-card outlined rounded="lg"
            ><v-card-subtitle class="justify-center"
              >Species: Human</v-card-subtitle
            ></v-card
          >
          <v-card outlined rounded="lg"
            ><v-card-subtitle class="justify-center"
              >scRNA-Seq</v-card-subtitle
            ></v-card
          >
        </v-row>
        <v-row class="px-8">
        ...
        <v-row class="px-12">
          <v-expand-transition>
            <v-card v-show="expand" class="mx-auto my-4" width="1060" outlined>
              <v-toolbar color="warning" short dark>
                <v-toolbar-title class="mx-auto">P00001-XX001</v-toolbar-title>
              </v-toolbar>
              <v-row class="ma-2">
        ...
        <v-row class="px-10">
          <v-expand-transition>
            <v-card v-show="expand1" class="mx-auto my-4" width="1060" outlined>
              <v-toolbar color="success" short dark>
                <v-toolbar-title class="mx-auto">P00002-XX008</v-toolbar-title>
              </v-toolbar>
              <v-row class="ma-2">
                <v-col justify="center">
                  <v-row justify="center">
              ...
              <v-row class="mb-4" justify="center">
                <v-btn color="primary">Archive</v-btn>
              </v-row>
            </v-card>
          </v-expand-transition>
        </v-row>
        ...
        <v-row class="px-8">
          <v-expand-transition>
            <v-card v-show="expand2" class="mx-auto my-4" width="1060" outlined>
              <v-toolbar color="error" short dark>
                <v-toolbar-title class="mx-auto">P00005-XX007</v-toolbar-title>
              </v-toolbar>
              <v-row class="ma-2">
                <v-col justify="center">
                  <v-row justify="center">
              ...
              <v-row class="mb-4" justify="center">
                <v-stepper>
                  <v-stepper-header>
                    ...
                    <v-divider></v-divider>
                    <v-stepper-step editable :rules="[() => false]" step="2">
                      Cluster
                    </v-stepper-step>
                    <v-divider></v-divider>
    ...
    <v-row class="my-12 justify-center">
      <v-card class="my-12" color="#ECEFF1" outlined rounded="lg" width="1140">
        <v-row justify="center">
          <v-icon x-large>mdi-alert-circle</v-icon>
        </v-row>
        <v-card-title class="justify-center">No Project Found!</v-card-title>
      </v-card>
    </v-row>
  </v-container>
</template>
